...
public class RotationTest extends Application {
    ...
    public void start(final Stage stage) throws Exception {
        ...
        final Slider zPivotSlider = createSlider(0,
                "Won't do anything until you use an X or Y axis of rotation");
        ...
        axisControl.getChildren()
                .addAll(new Label("Axis of Rotation"), xAxisToggleButton, yAxisToggleButton,
                        zAxisToggleButton);
        ...
        layout.getChildren().addAll(
                VBoxBuilder.create().spacing(10).alignment(Pos.TOP_CENTER)
                        .children(xPivotControl, yPivotControl, zPivotControl, axisControl).build(),
                displayPane
        );
        layout.setStyle(
     ...
     * @param helpText the tool tip textToBeRendered to use for the slider.
